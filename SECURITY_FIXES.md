...
| 7 | **`army_units` 缺 (player_id, type) 唯一约束** | V5 迁移 [V5__schema_hardening.sql](file:///Users/chenjuan/Documents/游戏/backend/src/main/resources/db/migration/V5__schema_hardening.sql) 加 `UNIQUE KEY uq_army_player_type` + 去重脚本 |
